...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-01-2023 a las 16:12:57
...
(5, 'Deportes', 'Todo tipo de deporte que sea imposible de realizar en el mundo real.', 'default-placeholder-gris.png', NULL),
(6, 'Ropa', 'Todo tipo de ropa que se pueda comprar en el metaverso.                                                                                                                                    ', 'categoria/6/img.png', NULL),
(7, 'Comida', 'Todo tipo de comidas que se pueden comer en el metaverso.', 'default-placeholder-gris.png', NULL),
(8, 'Viajes', 'Todo tipo de viaje que se puede realizar en el metaverso.', 'default-placeholder-gris.png', NULL),
...
(15, 17, 4, 'comentario test', '2023-01-26'),
(16, 17, 5, 'comentario test2', '2023-01-26');
...
(2, 'Ropa-Gafas-001', 'Gafas de sol para el metaverso', 5.211, 'default-placeholder-gris.png', 'default-placeholder-gris.png', 'default-placeholder-gris.png', '0', '0', 9),
(3, 'Escalada-Rascacielos-001', 'Escalada burj kalifa', 7.3421, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 5),
(4, 'KFC-001 Cena en el k', 'Cena en el kfc del metaverso       Cena en el kfc del m', 2.12, 'producto/4/img1.png', 'producto/4/img2.png', NULL, '0', '0', 7),
(5, 'Viaje-Egipto', 'Viaje a egipto en el metaverso', 12.21, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 8),
(6, 'Viaje-Venecia', 'Viaje a venecia en el metaverso', 17.432, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 8),
(7, 'Ropa-Sudadera-001', 'Sudadera adidas en el metaverso', 3.211, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 6),
(8, 'Ropa-Gorra-001', 'Gorra en el metaverso', 0.43, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 6),
(9, 'Puenting-Ebro-001', 'Puenting en el Ebro en el metaverso', 3.321, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 5),
(10, 'Viaje-Madrid', 'Viaje a madrid en el metaverso', 2.12, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 8),
(11, 'Ropa-Sudadera-002', 'Sudadera nike metaverso', 4.211, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 6),
(12, 'Viaje-Amsterdam', 'Viaje a amsterdam en el metaverso', 8.54, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 8),
(13, 'Ropa-Gafas-002', 'Gafas de sol Rayban en el metaverso', 15.211, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 6),
(14, 'Viaje-Viena', 'Viaje a viena en el metaverso', 4.43, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 8),
(15, 'Vips-001', 'Comida en el vips en el metaverso', 6.54, 'default-placeholder-gris.png', NULL, NULL, NULL, NULL, 7),
(16, 'Paracaidismo-Logroño', 'Paracaidismo en logroño en el metaverso', 9.1, 'producto/16/img1.png', NULL, NULL, '0', '0', 5);
...
(2, 'naveenspano@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Naveeeeen', 'Spanosss', 100.0000, 0),
...
(12, 'marcialtomas@gmail.com', '451ccbcfb38e939c6f7516bc0c9b97a4bf6eace7', 'Marcial', 'Tomas', 100.0000, 0),
(13, 'timoteofajardo@gmail.com', '451ccbcfb38e939c6f7516bc0c9b97a4bf6eace7', 'Timoteo', 'Fajardo', 100.0000, 0),
(14, 'ulisescarranza@gmail.com', '451ccbcfb38e939c6f7516bc0c9b97a4bf6eace7', 'Ulises', 'Carranza', 100.0000, 0),
(15, 'fidelcarvajal@gmail.com', '451ccbcfb38e939c6f7516bc0c9b97a4bf6eace7', 'Fidel', 'Carvajal', 100.0000, 0),
(16, 'juanjose@gmail.com', '451ccbcfb38e939c6f7516bc0c9b97a4bf6eace7', 'Juan', 'Jose', 100.0000, 0),
(17, 'miguelpol@gmail.com', '451ccbcfb38e939c6f7516bc0c9b97a4bf6eace7', 'Miguel', 'Pol', 100.0000, 0),
(18, 'albertopedrero@gmail.com', '451ccbcfb38e939c6f7516bc0c9b97a4bf6eace7', 'Alberto', 'Pedrero', 100.0000, 0);
...
--
ALTER TABLE `comentario`
  MODIFY `CodComentario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `compra`
--
ALTER TABLE `compra`
  MODIFY `CodCompra` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
